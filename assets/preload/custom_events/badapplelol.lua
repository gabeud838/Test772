...
function onEvent(n, v1, v2)
	if n == 'badapplelol' and string.lower(v1) == 'a' then
		...
		doTweenAlpha('applebadxd696666', 'light', 0, v2, 'linear')
		doTweenAlpha('badapplf', 'timeBar', 0, v2, 'linear')
		doTweenAlpha('badapplff', 'scoreTxt', 0, v2, 'linear')
		doTweenAlpha('badapplfff', 'timeTxt', 0, v2, 'linear')
	...
	if n == 'badapplelol' and string.lower(v1) == 'b' then
		...
		doTweenAlpha('applebadxd696666', 'light', 1, v2, 'linear')
		doTweenAlpha('badapplf', 'timeBar', 1, v2, 'linear')
		doTweenAlpha('badapplff', 'scoreTxt', 1, v2, 'linear')
		doTweenAlpha('badapplfff', 'timeTxt', 1, v2, 'linear')
